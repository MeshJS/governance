    ...
    <div className={styles.proposalDetails}>
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          ...
          <div className={styles.projectId}>Project ID: {details.projectId}</div>
        </div>

        <div className={styles.statusAndCategory}>
          <div
            className={`${styles.status} ${styles[details.status.toLowerCase().replace(' ', '')]}`}
          >
            {details.status}
          </div>
          <div className={styles.categoryTag}>{details.fundingCategory}</div>
        </div>
      ...
      {objective && (
        <div className={styles.section}>
          <div className={styles.objectiveHeader}>
            ...
            <button className={styles.readFullProposalButton} onClick={() => setIsModalOpen(true)}>
              Read Full Proposal
            </button>
          </div>
