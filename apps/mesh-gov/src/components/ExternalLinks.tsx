  ...
  return (
    <div className={styles.section}>
      ...
      <div className={styles.links}>
        <a href={projectLink} target="_blank" rel="noopener noreferrer" className={styles.link}>
          View full Proposal on Catalyst Website →
        </a>
        <a href={milestonesLink} target="_blank" rel="noopener noreferrer" className={styles.link}>
