...
const CustomLegend: React.FC<CustomLegendProps> = ({ topContributors, selectedContributors, onContributorToggle }) => {
    return (
        <div style={{
            display: 'flex',
            flexWrap: 'wrap',
                        ...
                        <defs>
                            {chartData?.topContributors?.map((contributor: Contributor, index: number) => {
                                ...
                                if (!shouldHighlight) {
                                    ...
                                    return (
                                        <linearGradient key={`gradient-${contributor.login}`} id={`gradient-${contributor.login}`} x1="0" y1="0" x2="0" y2="1">
                            ...
                            return (
                                <React.Fragment key={contributor.login}>
                                    ...
                                    <Line
                                        ...
                                        stroke={shouldHighlight ? `url(#gradient-${contributor.login})` : getDimmedColor(baseColor)}
