        ...
        milestoneDetails: [
            {
                ...
                description: "Re-factor and re-format documentation on all levels to meet the requirements of AI driven development, including AI-optimized inline documentation and web docs",
                budget: 25000,
            ...
            },
            {
                ...
                description: "Develop a RAG (Retrieval-Augmented Generation) driven AI assistant embedded in the web docs page to provide contextual help to developers",
                budget: 25000,
            ...
            },
            {
                ...
                description: "Create Model Context Protocol servers to allow AI agents to interact directly with the blockchain through Mesh functionalities",
                budget: 20000,
            ...
            },
            {
                ...
                description: "Comprehensive testing and refining of the software products, collaborative peer testing with No.Witness labs, and Discord bot showcase",
                budget: 20000,
                duration: "May 2026",
                outcomes: [
            ...
            },
            {
                ...
                description: "Create close-out report and video, comprehensive user guides, and license all code under open source license",
                budget: 10000,
                duration: "June 2026",
                outcomes: [
                                                ...
                                                <div className={styles.roadmapTags}>
                                                    {milestone.outcomes.slice(0, 3).map((outcome, idx) => (
                                                        <span key={idx} className={styles.roadmapTag}>
                                                            {outcome.replace('Refactored', '').replace('Develop a', '').replace('Create and submit', '').trim()}
                                                        </span>
                                                    ))}
