        ...
        <div className={styles.sidebar}>
          ...
          <div className={styles.linksCard}>
            ...
            <div className={styles.linksList}>
              ...
              <a
                href="https://projectcatalyst.io/funds/14/cardano-open-developers/mesh-transaction-v2-unified-serialization-feat-pallas"
                target="_blank"
                rel="noopener noreferrer"
                className={styles.resourceLink}
              >
      ...
      <div className={styles.keyFeaturesSection}>
        ...
        <div className={styles.featuresGrid}>
          <div className={styles.featureCard}>
            ...
            <p>
              Consolidate fragmented tx-builders across Whisky, core-csl, and core-cst into a
              single, coherent framework with consistent APIs and patterns.
            </p>
          </div>
          ...
          <div className={styles.featureCard}>
            ...
            <p>
              Implement a modular, extensible Tx class built on solid design principles that makes
              transaction building intuitive and maintainable for developers.
            </p>
          </div>
          ...
          <div className={styles.featureCard}>
            ...
            <p>
              Create comprehensive, AI-optimized documentation that serves both human developers and
              AI models, accelerating adoption and reducing learning curves.
            </p>
          </div>
          ...
          <div className={styles.featureCard}>
            ...
            <p>
              Eliminate duplication, reduce complexity, and provide consistent patterns that make
              extending and maintaining transaction logic straightforward.
            </p>
          </div>
        </div>
      </div>
