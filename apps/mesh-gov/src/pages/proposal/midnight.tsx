        ...
        milestoneDetails: [
            {
                ...
                description: "Develop smart contract logic and witness code for token minting, burning, and fractionalization with comprehensive testing framework",
                budget: 20000,
                duration: "Month 3",
                outcomes: [
            ...
            },
            {
                ...
                description: "Create staking logic with delegation mechanics, rewards distribution, and comprehensive testing framework",
                budget: 20000,
                duration: "Month 6",
                outcomes: [
            ...
            },
            {
                ...
                description: "Final documentation, video walkthrough, and comprehensive reporting of the complete framework",
                budget: 5000,
                duration: "Month 10",
                outcomes: [
                                                ...
                                                <div className={styles.roadmapTags}>
                                                    {milestone.outcomes.slice(0, 3).map((outcome, idx) => (
                                                        <span key={idx} className={styles.roadmapTag}>
                                                            {outcome.replace('Smart contract logic and witness code for', '').replace('API implementation with', '').trim()}
                                                        </span>
                                                    ))}
