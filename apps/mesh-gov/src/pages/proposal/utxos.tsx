...
export default function UtxosProposal() {
    ...
    const proposalData = {
        ...
        // Additional Details
        fullDescription: "Cardano and Bitcoin lack business-ready onboarding tools such as non custodial wallets, social logins and gasless transactions, leaving them behind ecosystems like Ethereum. UTXOS provides wallet-as-a-service, transaction sponsorship, and fiat on-ramp, enabling seamless onboarding and adoption for Cardano and Bitcoin apps.",
        ...
        milestoneDetails: [
            ...
            },
            {
                ...
                description: "Launch UTXOS with at least 10 clients, complete and launch the updated SDK, and publish comprehensive developer documentation",
                budget: 45000,
                duration: "June",
                outcomes: [
                    "Product Launch",
            ...
            },
            {
                ...
                description: "Create official close-out report and video, publish success metrics, and include UTXOS usage data on Mesh Dashboard",
                budget: 10000,
                duration: "July",
                outcomes: [
                                                ...
                                                <div className={styles.roadmapTags}>
                                                    {milestone.outcomes.slice(0, 3).map((outcome, idx) => (
                                                        <span key={idx} className={styles.roadmapTag}>
                                                            {outcome.replace('Develop and deploy', '').replace('Complete &', '').replace('Create', '').trim()}
                                                        </span>
                                                    ))}
