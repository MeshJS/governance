    ...
    const fetchProposals = async () => {
      try {
        const response = await fetch(
          'https://raw.githubusercontent.com/Signius/mesh-automations/main/mesh-gov-updates/catalyst-proposals/catalyst-data.json'
        );
    ...
    <div className={styles.container}>
      <div className={styles.chartsContainer}>
        <div className={styles.chartSection}>
          <DonutChart title="Budget Distribution" data={budgetData} total={totalBudget} />
        </div>
        <div className={styles.chartSection}>
