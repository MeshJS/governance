    ...
    <div className={styles.container}>
      ...
      <div className={styles.grid}>
        ...
        <Link
          ...
          className={`${styles.section} ${styles.proposalsOverview}`}
        >
          <div className={styles.sectionHeader}>
        ...
        <Link
          href="/mesh-stats"
          className={`${styles.section} ${styles.downloads} ${styles.compactCard}`}
        >
          <div className={styles.sectionHeader}>
        ...
        <Link
          href="/contributors"
          className={`${styles.section} ${styles.contributors} ${styles.compactCard}`}
        >
          <div className={styles.sectionHeader}>
